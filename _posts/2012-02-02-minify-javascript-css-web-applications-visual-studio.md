...
- [JSMin](http://crockford.com/javascript/jsmin){:target="_blank"}
- [YUI Compressor](http://developer.yahoo.com/yui/compressor/){:target="_blank"}
- [Microsoft Ajax Minifier](http://ajaxmin.codeplex.com/){:target="_blank"}
...
- [Wikipedia: Minification (programming)](http://en.wikipedia.org/wiki/Minification_(programming)){:target="_blank"}
- [Yahoo’s Best Practices for Speeding Up Your Web Site](http://yhoo.it/R35J){:target="_blank"}
