...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/1.png" caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/2.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
Para trabajar con el APIM desde código C#, lo más conveniente es usar el paquete NuGet que nos proporciona Microsoft aquí: [https://www.nuget.org/packages/Azure.ResourceManager.ApiManagement](https://www.nuget.org/packages/Azure.ResourceManager.ApiManagement){:target="_blank"}.
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/3.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/4.png" caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/5.png" caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/6.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/7.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/8.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/9.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/10.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/12.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/13.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/14.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/15.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/16.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
{% include figure class="align-center" imagePath="/images/2023-05-31-moneitzar-apis-inteligencia-artificial-parte-3/17.png" imageBorder=false caption="Haz click para ver la imagen más grande." %}
...
Por último, puede ser interesante destacar que en una implementación "más real" que la de esta demo, cada acción que realiza esta Azure Function esté repartida entre varias Azure Functions, conectadas entre sí mediante un mecanismo que siga el patrón de diseño «[Transactional Outbox](https://microservices.io/patterns/data/transactional-outbox.html){:target="_blank"}», el cual es relativamente sencillo de implementar utilizando Cosmos DB y su funcionalidad de «[Change Feed](https://learn.microsoft.com/en-us/azure/cosmos-db/change-feed){:target="_blank"}» combinada con la capacidad de «[Transactional Batches](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/transactional-batch?tabs=dotnet){:target="_blank"}», aunque eso es tema para otra conversación y otra publicación 😉
