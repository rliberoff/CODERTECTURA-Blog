...
last_modified_at: 2023-10-25 00:00:00 +0000
layout: post
permalink: /posts/nos-vemos-en-microsoft-365-live-2023
image: 
...
Este es un evento de la comunidad **muy** presitigioso organizado desde Latinoamérica por [Fernando Chiquiza](https://www.linkedin.com/in/fchiquiza/){:target="_blank"} y con participantes de muchísimos países de habla hispana.

En esta ocasión, a diferencia de sesiones anteriores, he decido por volcarme un poco más al mundo «[Low-Code](https://powerapps.microsoft.com/en-us/low-code-platform/){:target="_blank"}» mostranado como podemos combinar *prompts* creados en Azure OpenAI con un modelo GPT-3.5-Turbo o GPT-4 con un flujo en Power Automate que puede ser utilizado por un Power Virtual Agent con el cual los usuarios podrán interactuar a través de Microsoft Teams.
...
{% include figure class="align-center" imagePath="/images/2023-10-25-nos-vemos-en-microsoft-365-live-2023/1.jpg" lightbox=false imageStyle="width:55%" %}
