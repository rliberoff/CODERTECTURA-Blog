...
last_modified_at: 2023-11-20 00:00:00 +0000
layout: post
permalink: /posts/netcoreconf-2023-madrid-planificando-para-el-exito
image: 
...
categories:
  ...
  - Tutorial
---
¡Pues ya tenemos publicado en [YouTube](https://youtu.be/oE1NIXiq-hE?si=t7b_jr948XQGu-bi){:target="_blank"} la sesión que di [hace unas semanas](/posts/nos-vemos-en-la-net-core-conf-2023-madrid) en la [Netcoreconf 2023](https://netcoreconf.com/){:target="_blank"} de Madrid junto con mi complice habitual [Borja Piris de Castro](https://www.linkedin.com/in/borja-piris/){:target="_blank"}.
...
{% include responsive-embed url="https://www.youtube.com/embed/oE1NIXiq-hE?si=2O-Nsjjz7LS-POmw" ratio="16:9" title="¡Planificando para el éxito! Usando los Planners de Semantic Kernel para realizar metas." class="image-border" style="width:70%" %}
...
A continuación te mostraré como funcionan cada uno de éstos, y los mejores escenarios para utilizarlos. Recuerda que todo el código fuente lo tienes disponible en mi [GitHub aquí](https://github.com/rliberoff/.NET-Core-Conf-2023){:target="_blank"}.
...
El «Stepwise Planner» es un poderoso planificador basado en una arquitectura neurosimbólica denominada en sus términos en ingles como «Modular Reasoning, Knowledge and Language» ([MRKL](https://arxiv.org/pdf/2205.00445.pdf){:target="_blank"}, y pronunciado *miracle* en Inglés).
...
{% include figure class="align-center" imagePath="/images/2023-11-20-netcoreconf-2023-madrid-planificando-para-el-exito/logs.png" caption="Haz click para ver la imagen más grande." imageBorder=true %}

Recuerda que tienes más detalle de todo esto en el código de esta publicación en mi [GitHub aquí](https://github.com/rliberoff/.NET-Core-Conf-2023){:target="_blank"}.

## ¿Dónde está la mágia?

Como decía antes, los planificadores no son más que *plugins* para Semantic Kernel con funciones que utilizan mensajes para un LLM (*Large Language Model*), habitualmente alguno de OpenAI, para generar un plan. Por ejemplo, el mensaje que utiliza el «Sequential Planner» lo podeos encontrar en el código fuente de Semantic Kernel dentro de un archivo `skprompt.txt` (es decir, que es una [función semántica](https://youtu.be/jc6H8gmXAAA?si=bnXygSteId3XR64Q){:target="_blank"}), y parece algo así como lo siguiente:
...
{% include responsive-embed url="https://www.slideshare.net/slideshow/embed_code/key/8fAP7L3yaRBoeL" ratio="16:9" title="¡Planificando para el éxito! Usando los Planners de Semantic Kernel para realizar metas." class="image-border" %}
