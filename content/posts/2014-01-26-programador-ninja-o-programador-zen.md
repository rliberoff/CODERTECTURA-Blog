---
slug: programador-ninja-o-programador-zen
...
url: "/posts/programador-ninja-o-programador-zen/"
image:
...
categories:
    - Divagaciones
---
Hoy día las empresas se han vuelto adictas a implementar una u otra forma de «desarrollo ágil» de software, que en la gran mayoría de las veces termina convirtiéndose o traduciéndose en una forma degenerada y poco saludable de proceso de «construye y despliega» sin parar.
...
{{< figure src="/images/2014-01-26-programador-ninja-o-programador-zen/ninja.jpg" alt="image-left" class="align-left" imageClass="image-border" imageStyle="width: 250;" >}}{{< /figure >}}
...
{{< figure src="/images/2014-01-26-programador-ninja-o-programador-zen/zen.webp" alt="image-right" class="align-right" imageClass="image-border" imageStyle="width: 250;" >}}{{< /figure >}}El programador Zen comparte algunas características con el programador Ninja, pero su principal diferencia es que, aunque son ágiles, no están orientados a entregar software de forma rápida. Se toman su tiempo, meditan y vuelven a meditar antes de tomar alguna acción.
...
### Y entonces… ¿qué es mejor, Programador Ninja o Programador Zen?
