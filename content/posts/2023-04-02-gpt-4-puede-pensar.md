...
{{< republished blog="Tranformación Digital" url="https://blogs.encamina.com/transformacion-digital/es-gpt-4-capaz-de-pensar-o-ser-consciente-de-si-mismo/" >}}
...
A lo largo de esta publicación, estaremos conversando sobre los experimentos y hallazgos publicados en el *paper* <a href="https://arxiv.org/abs/2303.12712" target="_blank" rel="noopener noreferrer">“Sparks of Artificial General Intelligence: Early experiments with GPT-4”</a> que justamente busca determinar si GPT-4 como algoritmo, aplicación o sistema es «inteligente», e incluso si tiene algún nivel de «conciencia» primitiva. Es decir, si es capaz de pensar y de ser.
...
{{< figure src="/images/2023-04-02-es-gpt-4-capaz-de-pensar/1.png" class="align-center" caption="Comparación entre GPT-4 y GPT-3 (representado como ChatGPT) en un ejercicio sobre el razonamiento aplicado al comportamiento humano y la distinción de intenciones." lightbox="false" imageBorder="false" >}}{{< /figure >}}

{{< figure src="/images/2023-04-02-es-gpt-4-capaz-de-pensar/2.png" class="align-center" caption="Capacidad de GPT-4 de razonar sobre escenarios complejos, desafiantes y de naturaleza personal." lightbox="false" imageBorder="false" >}}{{< /figure >}}
...
<p style="color:#696969; text-align: center;">¿De qué color era el oso?»</p>
...
{{< figure src="/images/2023-04-02-es-gpt-4-capaz-de-pensar/3.png" class="align-center" lightbox="false" imageBorder="false" >}}{{< /figure >}}
...
<p style="color:#696969; text-align: center;">¿De qué especie es el tigre?</p>
...
{{< figure src="/images/2023-04-02-es-gpt-4-capaz-de-pensar/4.png" class="align-center" lightbox="false" imageBorder="false" >}}{{< /figure >}}
...
<p style="font-weight: bold; text-align: center;">¡Todavía queda un largo camino por recorrer!</p>
...
Existe una práctica conocida como la “<a href="https://es.wikipedia.org/wiki/Teor%C3%ADa_de_la_mente" target="_blank" rel="noopener noreferrer">Teoría de la Mente</a>” en psicología, la cual permite atribuir representaciones independientes a uno mismo y a los demás para explicar las acciones propias y ajenas del contexto y mundo que nos rodea. Dado que los individuos tienden a suponer cosas que en realidad no existen, estas representaciones deben estar libres tanto de la condición real de las cosas como de las concepciones de otras personas (porque las personas pueden esperar y desear cosas diferentes). Este tipo de teorías ayuda a conceptualizar escenarios para identificar la «conciencia» y la percepción de «ser».

Esto anterior, tan enredado, puede explicarse fácilmente con el experimento de <a href="https://en.wikipedia.org/wiki/Sally%E2%80%93Anne_test" target="_blank" rel="noopener noreferrer">Sally-Anne</a> (de 1980). Dicho experimento usa niños y dos títeres o muñecas llamadas Sally y Anne para representar la siguiente situación:
...
<p style="color:#696969; text-align: center;">“¿Dónde buscará Sally por su juguete?"</p>

Muchos niños entre cuatro y siete años contestan “dentro de la caja de Anne” ya que aparentemente no entienden que el conocimiento que poseen no es el mismo que el de Sally, ya que ella estaba fuera de la habitación paseando, y no fue testigo del cambio. Básicamente, manifiestan saber y conocer cambios del entorno y lo proyectan sobre éste, algo que según ciertos investigadores (<a href="https://arxiv.org/ftp/arxiv/papers/2302/2302.02083.pdf" target="_blank" rel="noopener noreferrer">como los de la universidad de Stanford</a>), se verían como una prueba de la capacidad de asignar estados mentales no observables y prever acciones posteriores, es decir, que dentro de la “<a href="https://es.wikipedia.org/wiki/Teor%C3%ADa_de_la_mente" target="_blank" rel="noopener noreferrer">Teoría de la Mente</a>”, son conscientes.

Investigaciones recientes demuestran que, en los últimos años, **las redes neuronales y los grandes modelos de lenguaje (como GPT-3 y GPT-4) se han vuelto aparentemente más listos**. Ahora pueden abordar exitosamente problemas como la prueba de <a href="https://en.wikipedia.org/wiki/Sally%E2%80%93Anne_test" target="_blank" rel="noopener noreferrer">Sally-Anne</a>, así como otros que están más allá de la comprensión de personas de cuatro a siete años.
...
<br>
<p style="font-weight: bold; text-align: center;">¡Todavía queda mucho por hacer!</p>
