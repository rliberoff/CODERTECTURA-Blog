---
slug: apis-monetizacion-parte-2
...
url: "/posts/apis-monetizacion-parte-2/"
image:
...
{{< republished blog="Piensa en software, desarrolla en colores" url="https://blogs.encamina.com/piensa-en-software-desarrolla-en-colores/como-monetizar-nuestras-apis-de-inteligencia-artificial-con-el-azure-api-management-2a-parte/" >}}
...
{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/1.png" class="align-center" caption="Arquitectura en alto nivel para la monetización de APIs con el Azure API Management.<br>Haz click para ver la imagen más grande." >}}
{{< /figure >}}
...
Tras definir el modelo de negocio es probable que las siguientes tareas sean desarrollar una aplicación para su gestión que se integre con el Azure API Management (APIM) mediante su <a href="https://learn.microsoft.com/en-us/rest/api/apimanagement/" target="_blank" rel="noopener noreferrer">API REST de gestión</a> para crear y actualizar los elementos del modelo de negocio, siendo de los principales los Productos y las APIs vinculadas a cada uno.

Por temas de espacio de tiempo, crear tal tipo de aplicación se escapa al propósito de esta publicación, por lo cual simularemos el modelo de negocio diseñado empleando un archivo JSON que podrás encontrar en el repo de GitHub aquí 👉 <a href="https://github.com/rliberoff/Global-Azure-Spain-2023-API-Monetization/blob/main/businessModel/monetizationModels.json" target="_blank" rel="noopener noreferrer">https://github.com/rliberoff/Global-Azure-Spain-2023-API-Monetization/blob/main/businessModel/monetizationModels.json</a>.

Como tal, el fichero se ve así (lo pongo en un GIF animado porque es muy largo):

{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/2.gif" class="align-center" caption="Extracto del JSON que representa (simula) el modelo de negocio." lightbox="false" imageStyle="width: 650px;" >}}
{{< /figure >}}
...
{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/3.png" class="align-center" caption="Como se ve el modelo de negocio en el Azure API Management, en el apartado de «Productos».<br>Haz click para ver la imagen más grande." >}}
{{< /figure >}}
...
Una vez que tenemos este API Key, vamos a ver qué hace este *script*, el cual encontrarás completo en el repo de GitHub aquí 👉 <a href="https://github.com/rliberoff/Global-Azure-Spain-2023-API-Monetization/blob/main/scripts/stripeInitialisation.ps1" target="_blank" rel="noopener noreferrer">https://github.com/rliberoff/Global-Azure-Spain-2023-API-Monetization/blob/main/scripts/stripeInitialisation.ps1</a>.
...
{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/4.png" class="align-center" caption="Ubicación de la URL del Azure API Management Gateway.<br>Haz click para ver la imagen más grande." >}}
{{< /figure >}}

- Una de las claves de subscripción del APIM, siendo la recomendada la que ya trae definida al provisionarse el recurso:

{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/5.png" class="align-center" caption="Ubicación de las claves de subscripción en el Azure API Management.<br>Haz click para ver la imagen más grande." >}}
{{< /figure >}}

La llamada al *script* se ve de la siguiente forma:

{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/6.png" class="align-center" caption="Haz click para ver la imagen más grande." imageBorder="false" >}}
{{< /figure >}}

La primera parte del *script* se encarga de instalar la versión más reciente del CLI de Stripe:

{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/7.png" class="align-center" caption="Primera parte del *script* de PowerShell de configuración de Stripe que se encarga de capturar los parámetros y de instalar el CLI de Stripe.<br>Haz click para ver la imagen más grande." imageBorder="false" >}}
{{< /figure >}}
...
{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/8.png" class="align-center" caption="Haz click para ver la imagen más grande." imageBorder="false" >}}
{{< /figure >}}
...
{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/9.png" class="align-center" caption="Haz click para ver la imagen más grande." imageBorder="false" >}}
{{< /figure >}}

Tras ejecutar este *script*, si entramos en nuestra cuenta de Stripe veremos como los productos estarán configurados:

{{< figure src="/images/2023-05-30-moneitzar-apis-inteligencia-artificial-parte-2/10.png" class="align-center" caption="Haz click para ver la imagen más grande." >}}
{{< /figure >}}
