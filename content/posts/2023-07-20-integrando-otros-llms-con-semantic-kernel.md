...
url: "/posts/integrando-otros-llms-con-semantic-kernel/"
image:
...
¡Quédate conmigo que te explico cómo podemos integrar modelos de otros LLMs (*Large Language Models*) como los disponibles en <a href="https://huggingface.co/deepset/roberta-base-squad2" target="_blank" rel="noopener noreferrer">Hugging Face</a> en nuestros proyectos de IA usando Funciones Nativas y *plugins* de Semantic Kernel!

El código fuente de este artículo lo podéis conseguir en GitHub, aquí 👉🏻 <a href="https://github.com/rliberoff/BLOG-001-Semantic-Kernel-Native-Functions" target="_blank" rel="noopener noreferrer">https://github.com/rliberoff/BLOG-001-Semantic-Kernel-Native-Functions</a>.
...
{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/1.png" class="align-center" lightbox="false" imageBorder="false" >}}{{< /figure >}}

En nuestro caso, vamos a realizar una integración con «`roberta-base-squad2`» disponible en <a href="https://huggingface.co/deepset/roberta-base-squad2" target="_blank" rel="noopener noreferrer">Hugging Face</a>. Este modelo nos permite integrarnos con un LLM llamado <a href="https://arxiv.org/abs/1907.11692" target="_blank" rel="noopener noreferrer">RoBERTa</a> (nombre gracioso para *Robustly Optimized BERT Approach*) desarrollado por la empresa <a href="https://www.deepset.ai/" target="_blank" rel="noopener noreferrer">deepset</a> (los mismos de <a href="https://haystack.deepset.ai/" target="_blank" rel="noopener noreferrer">Haystack</a>).
...
{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/2.png" class="align-center" lightbox="false" imageBorder="false" >}}{{< /figure >}}

Recordemos que las clases de opciones las configuramos con inyección de dependencias en el archivo `Program.cs`:

{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/3.png" class="align-center" lightbox="false" imageBorder="false" >}}{{< /figure >}}
...
{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/4.png" class="align-center" caption="Haz click para ver la imagen más grande." imageBorder="false" >}}{{< /figure >}}
...
{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/5.png" class="align-center" caption="Haz click para ver la imagen más grande." imageBorder="false" >}}{{< /figure >}}
...
{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/6.png" class="align-center" caption="Haz click para ver la imagen más grande." imageBorder="false" >}}{{< /figure >}}
...
Para probar esto, os dejo una colección de Postman con esta llamada y que está disponible en el repo en <a href="https://github.com/rliberoff/BLOG-001-Semantic-Kernel-Native-Functions" target="_blank" rel="noopener noreferrer">GitHub</a> mencionado al principio del artículo. Abajo tienes dos imágenes de una respuesta correcta y otra de “no sé” 👇🏻

{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/7.png" class="align-center" imageBorder="false" >}}{{< /figure >}}

{{< figure src="/images/2023-07-20-integrando-otros-llms-con-semantic-kernel/8.png" class="align-center" caption="Haz click para ver las imagenes más grandes." imageBorder="false" >}}{{< /figure >}}

### Más información

Si tienes más curiosidad sobre Semantic Kernel, te dejo aquí algunas publicaciones de mi <a href="https://www.youtube.com/@CODERTECTURA" target="_blank" rel="noopener noreferrer">YouTube</a> donde justamente trato sobre estos temas:

- Configuración paso a paso del Semantic Kernel 👉🏻 <a href="https://youtu.be/a8gNdF0D23g" target="_blank" rel="noopener noreferrer">https://youtu.be/a8gNdF0D23g</a>

{{< responsive-embed url="https://www.youtube.com/embed/a8gNdF0D23g" ratio="16:9" title="SEMANTIC KERNEL - Configuración PASO a PASO 👣" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" class="image-border" style="margin-top: 20px; margin-left: 50px; width:55%" >}}{{< /responsive-embed >}}

- Las Funciones Semánticas en Semantic Kernel 👉🏻 <a href="https://youtu.be/jc6H8gmXAAA" target="_blank" rel="noopener noreferrer">https://youtu.be/jc6H8gmXAAA</a>

{{< responsive-embed url="https://www.youtube.com/embed/jc6H8gmXAAA" ratio="16:9" title="Te eneseño cómo son las Funciones Semánticas en SEMANTIC KERNEL" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" class="image-border" style="margin-top: 20px; margin-left: 50px; width:55%" >}}{{< /responsive-embed >}}

- Las Funciones Nativas en Semantic Kernel 👉🏻 <a href="https://youtu.be/mSJa0oaS_XE" target="_blank" rel="noopener noreferrer">https://youtu.be/mSJa0oaS_XE</a>
